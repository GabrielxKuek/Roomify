...
type DialogAnchorSetElement = (
  prevElement: ReactNode | undefined,
  element: ReactNode | undefined
) => void;

const DialogAnchorContext = createContext<DialogAnchorSetElement | undefined>(
  undefined
);
...
export function DialogAnchor({ children }: DialogAnchorProperties) {
  ...
  const set = useCallback<DialogAnchorSetElement>(
    (prevElement, element) =>
      setElement((e) => (e === prevElement ? element : e)),
    []
  );
  return (
    <>
...
const DialogAnchorProvider = memo(
  ({
    children,
    set,
  }: {
    children?: ReactNode;
    set: DialogAnchorSetElement;
  }) => {
    return (
      <DialogAnchorContext.Provider value={set}>
        {children}
...
export const DialogTrigger: (
  props: DialogTriggerProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef(({ onClick, ...props }, ref) => {
...
export const DialogOverlay: (
  props: DialogOverlayProperties & RefAttributes<ComponentInternals>
...
export function DialogContentPrimitive({
  children,
}: DialogContentPrimitiveProperties) {
  const dialogContext = useDialogContext();
  useEffect(
    () =>
      dialogContext.setContent(
...
export const DialogContent: (
  props: DialogContentProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef(({ children, sm, ...props }, ref) => {
...
export const DialogHeader: (
  props: DialogHeaderProperties & RefAttributes<ComponentInternals>
...
export const DialogFooter: (
  props: DialogFooterProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef(({ sm, ...props }, ref) => {
  return (
    <Container
